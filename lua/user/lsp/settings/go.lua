...
require("go").setup({
	...
	comment_placeholder = "TODO: Add description", -- comment_placeholder your cool placeholder e.g. ﳑ       
	icons = { breakpoint = icons.ui.BigUnfilledCircle, currentpos = icons.ui.ChevronRight },
	...
	lsp_diag_virtual_text = { space = 0, prefix = icons.ui.Fire }, -- virtual text setup
	lsp_diag_signs = true,
